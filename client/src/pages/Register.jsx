    ...
    <div style={{ display: 'flex', minHeight: '100vh', backgroundColor: 'var(--bg-primary)', padding: '2rem' }}>
      <div className="auth-container">
        ...
        <div className="auth-illustration">
           <img src="/login_illustration.png" alt="Register Illustration" style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
        </div>

        {/* Right Side: Form */}
        <div className="auth-form-side">
          <div style={{ display: 'flex', marginBottom: '1.5rem', alignItems: 'center', gap: '0.5rem' }}>
            <Briefcase size={32} className="logo-icon" />
            <h2 className="text-gradient" style={{ margin: 0 }}>JobTracker</h2>
          </div>
          
          <h1 style={{ fontSize: '2rem', fontWeight: '700', marginBottom: '0.5rem', color: 'var(--text-primary)' }}>Create an account</h1>
          <p style={{ color: 'var(--text-muted)', marginBottom: '1.5rem' }}>Start tracking your job applications today.</p>
          ...
          <form onSubmit={onSubmit}>
            ...
            <div style={{ marginBottom: '1.5rem' }}>
              <label style={{ display: 'block', marginBottom: '0.5rem', color: 'var(--text-secondary)', fontWeight: '500' }}>Confirm Password</label>
              <input 
                type="password" 
            ...
            <button type="submit" className="btn btn-primary" style={{ width: '100%', justifyContent: 'center', padding: '0.875rem' }} disabled={loading}>
              {loading ? <Loader2 size={18} style={{ animation: 'spin 1s linear infinite' }} /> : 'Register'}
            </button>
          </form>
          
          <div style={{ marginTop: '1.5rem', textAlign: 'center' }}>
            <Link to="/login" className="btn btn-secondary" style={{ width: '100%', justifyContent: 'center', padding: '0.875rem' }}>
              Log in instead
            </Link>
          </div>
        </div>
